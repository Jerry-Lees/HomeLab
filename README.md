...
(Update: I no longer use OCFS2 clusters, instead I use NFS mounts... easier to maintain and add new nodes in a multi-master multi-node setup-- plus it didn't involve me 'adding' process, it took process away. Probably not to the perfection RFC 1925 talks about, there's still stuff that could be taken away. ;-) )
